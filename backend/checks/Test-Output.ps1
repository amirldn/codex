...
Add-CodexOutput -CheckName "Test_Warn" -State Warn -Message "This is WARN test output" -ResolveSteps @("Step 1 of resolving","Step 2 of resolving","Step 3 of resolving")
