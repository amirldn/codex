...
Invoke-Command -Command { cd C:\codex-windows\frontend\; npm run install }
...
Copy-Item -Path "C:\codex-windows\redist\memurai-v3.1.4.msi" -Destination C:\codex-windows\prod\package\redist -Force
